...
<html>
    ...
    <p style="color:black;background-color:lightblue;font-size:13pt;width:100%;font-weight:bold;"> According to an analysis of job listing data from Indeed, SimplyHired, and Monster, Towards Data Science says the following are the most in-demand tech skills for data analysts:
...
<li>Oracle</li>
<li>Microsoft Power BI</li></ol>
<p style="color:black;">In addition to analytical and mathematical skills, and facility with languages such as SQL, communication skills are essential. Data analysts frequently need to engage with the business to understand business objectives and gather requirements.</p></p>
    </div>
